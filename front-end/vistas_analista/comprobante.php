        ...
        <div class="col s12">
            ...
            <div class="row">
                <form action="_indexAnalistaBean.php" method="post">
                    ...
                    <div class="row ">
                        <a href="index.php" class=" right btn waves-effect waves-light cyan lighten-1" type="submit" name="action">Regresar</a>
                        <a href="edicionPedido.php?id=<?php echo $Factura->getId()?>" class=" right btn waves-effect waves-light cyan lighten-1" type="submit" name="action">Editar</a>
                </form>
            </div>
            </form>
        </div>
